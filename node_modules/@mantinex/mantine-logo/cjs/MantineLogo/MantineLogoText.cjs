...
var useMantineLogoColors = require('./use-mantine-logo-colors.cjs');
var MantineLogo_module = require('./MantineLogo.module.css.cjs');
...
function MantineLogoText({
  ...
  return /* @__PURE__ */ React.createElement(
    "svg",
    {
      ...
      viewBox: "0 0 623 163",
      style: { height: core.rem(size), ...style },
      className: cx(
        MantineLogo_module.logo,
        { [MantineLogo_module.mantineUILogo]: variant === "ui.mantine.dev" },
        className
      )
    },
...
//# sourceMappingURL=MantineLogoText.cjs.map
